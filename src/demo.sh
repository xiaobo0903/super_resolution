...
#python main.py --data_test video --dir_demo ../test1/t1-1.mp4  --scale 2 --pre_train download --test_only --save_results
#python main.py --data_test video --dir_demo ../split.mp4  --scale 2 --res_width 1280 --res_height 720 --save edsr_x2 --pre_train download --test_only --save_results
python mainv.py --dir_sour ./video/source  --scale 3 --save ./video/target --pre_train download --test_only --save_results
#python main.py --scale 2 --pre_train download --test_only --save_results --data_test video --dir_demo ../2.avi
